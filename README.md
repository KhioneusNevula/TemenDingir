...
This is a concept that only makes sense on a multiplayer server, and determines how the god gets along with other gods. WARLIKE causes the god to frequently incite holy war missions to kill unbelievers. INVASIVE causes the god to incite peaceful missions to convert unbelievers. PEACEFUL causes the god's missions to be able to be done without interaction with other gods, and this is the default. FRIENDLY causes the god to attempt to ally with other gods to create a (?)Syncretism(?).
            ...
            <ul>
              <li>Regeneration at 2, 4, and 6: There is a chance of regeneration being applied to a worshiper when their health goes beneath 2, 4, 6 (depending on which is chosen) hearts. 
                <li>Armor Repairment: There is a chance of a worshiper's armor being repaired by the amount of attack dealt to it rather than damaged.
                  <li>Tool Repairment at 10%, 20%, 30%: There is a chance a worshiper's tool will be repaired up to half durability when lower than that durability
                    <li>Invisibility: When a worshiper is within 16 blocks of a hostile, there is a chance they will turn invisible
                      <li>Fire Protection: When a worshiper is on fire, there is a chance of gaining fire protection
                        <li>Water Breathing: When a worshiper is in water, there is a chance of gaining water breathing
                          <li>Night Vision: When a worshiper is in the dark, there is a chance of gaining night vision
                            <li>Let There Be Light: When a worshiper is in a place dark enough for mobs to spawn, they may get the Glowing Head status effect, causing their head to emit light.
            </ul>
