...
import com.gm910.temendingir.api.networking.TaskEvent;
...
public class Networking {
	 ...
	 * @param dim
	 */
	public static void sendToDim(TaskMessage msg, RegistryKey<World> dim) {
	 ...
	 * @param excluded
	 */
	public static void sendNear(TaskMessage msg, double x, double y, double z, RegistryKey<World> dim, int radius,
	 ...
	 * @param dim
	 */
	public static void sendToDim(ModTask msg, RegistryKey<World> dim) {
	 ...
	 * @param excluded
	 */
	public static void sendNear(ModTask msg, double x, double y, double z, RegistryKey<World> dim, int radius,
			@Nullable ServerPlayerEntity excluded) {
		ModChannels.INSTANCE.send(
				PacketDistributor.NEAR.with(() -> new PacketDistributor.TargetPoint(excluded, x, y, z, radius, dim)),
				new TaskMessage(msg));
