package com.gm910.temendingir.api.rendering;
...
public class RenderHelper {
	public static void render(World world, Vector3d pos, BlockState blockstate, float entityYaw, float partialTicks,
